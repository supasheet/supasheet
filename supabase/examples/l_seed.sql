...
values
  (
    ...
    'TECH',
    'Technology',
    'Cloud, infrastructure and engineering skills.'
  ),
  (
...
values
  (
    ...
    'e91cb03e-fb7a-424d-84ff-18e2791ce0b2',
    'Senior Cloud Architect & Educator',
    'Fifteen years building and teaching cloud infrastructure at scale.'
  ),
  (
    'a2000000-0000-0000-0000-000000000002',
    null,
    'Executive Communication Coach',
    'Works with leadership teams on clear, confident communication.'
  ),
  (
    'a2000000-0000-0000-0000-000000000003',
    null,
    'Workplace Compliance Specialist',
    'Designs mandatory training that people actually remember.'
  );
...
values
  (
    ...
    'beginner',
    'published',
    'The core building blocks of cloud infrastructure — compute, storage, networking and security.',
    0,
    true,
  ...
  (
    ...
    'advanced',
    'published',
    'Running production Kubernetes clusters at scale.',
    149,
    false,
  ...
  (
    ...
    'intermediate',
    'published',
    'Communicating clearly and confidently as a first-time manager.',
    99,
    false,
  ...
  (
    ...
    'beginner',
    'published',
    'Mandatory annual training on recognising and reporting workplace harassment.',
    0,
    true,
  ...
  (
    ...
    'intermediate',
    'draft',
    'Using analytics to plan and justify a marketing spend.',
    0,
    false,
    null,
  ...
  (
    ...
    'beginner',
    'published',
    'The fundamentals of usable, accessible product design.',
    79,
    false,
...
values
  ...
  (
    ...
    'How a production cluster is put together.'
  ),
  (
    'a4000000-0000-0000-0000-000000000004',
    'a3000000-0000-0000-0000-000000000002',
    'Operations at Scale',
    'Running and observing clusters in production.'
  ),
  (
    'a4000000-0000-0000-0000-000000000005',
    'a3000000-0000-0000-0000-000000000004',
    'Understanding Harassment',
    'What harassment looks like at work.'
  ),
  (
...
values
  (
    ...
    'video',
    null,
    'https://video.example/cloud-fundamentals/overview',
    5,
    true
  ),
  (
    ...
    'article',
    'Step-by-step guide to creating your first cloud account and CLI setup.',
    null,
    15,
    false
  ),
  (
    ...
    'video',
    null,
    'https://video.example/cloud-fundamentals/compute',
    20,
    false
  ),
  (
    ...
    'video',
    null,
    'https://video.example/cloud-fundamentals/storage-networking',
    25,
    false
  ),
  (
    ...
    'video',
    null,
    'https://video.example/cloud-fundamentals/security',
    20,
    false
  ),
  (
    ...
    'video',
    null,
    'https://video.example/k8s/control-plane',
    30,
    true
  ),
  (
    ...
    'video',
    null,
    'https://video.example/k8s/networking',
    35,
    false
  ),
  (
    ...
    'video',
    null,
    'https://video.example/k8s/autoscaling',
    25,
    false
  ),
  (
    ...
    'assignment',
    'Write a runbook for a simulated cluster outage.',
    null,
    40,
    false
  ),
  (
    ...
    'video',
    null,
    'https://video.example/harassment/definitions',
    15,
    true
  ),
  (
    ...
    'article',
    'The reporting channels available and what happens after you file a report.',
    null,
    10,
    false
  ),
  (
    ...
    'video',
    null,
    'https://video.example/leadership/clarity',
    18,
    true
  ),
  (
    ...
    'video',
    null,
    'https://video.example/ux/principles',
    22,
    true
  );
...
values
  (
    ...
    'b1000000-0000-0000-0000-000000000001',
    'Which of the following is a compute resource?',
    'single_choice',
    1
  ),
  (
    ...
    'b1000000-0000-0000-0000-000000000001',
    'Object storage is ideal for structured relational data.',
    'true_false',
    1
  ),
  (
    ...
    'b1000000-0000-0000-0000-000000000001',
    'What provides network isolation in the cloud?',
    'single_choice',
    1
  ),
  (
    ...
    'b1000000-0000-0000-0000-000000000002',
    'Retaliation against someone who reports harassment in good faith is prohibited.',
    'true_false',
    1
  ),
  (
    ...
    'b1000000-0000-0000-0000-000000000002',
    'Who should you contact first to report an incident?',
    'single_choice',
    1
  ),
  (
    ...
    'b1000000-0000-0000-0000-000000000003',
    'What Kubernetes object manages a set of replica pods?',
    'single_choice',
    1
  ),
  (
    ...
    'b1000000-0000-0000-0000-000000000003',
    'Horizontal Pod Autoscaling requires metrics-server to be running.',
    'true_false',
    1
  );
...
values
  ...
  (
    'b3000000-0000-0000-0000-00000000000c',
    'b2000000-0000-0000-0000-000000000004',
    'False',
    false
  ),
  (
    'b3000000-0000-0000-0000-00000000000d',
    'b2000000-0000-0000-0000-000000000005',
    'HR or your manager',
    true
  ),
  (
    'b3000000-0000-0000-0000-00000000000e',
    'b2000000-0000-0000-0000-000000000005',
    'Post on social media',
    false
  ),
  (
    'b3000000-0000-0000-0000-00000000000f',
    'b2000000-0000-0000-0000-000000000005',
    'Nothing, ignore it',
    false
  ),
...
values
  (
    ...
    'Cloud Engineer Path',
    'From cloud fundamentals through to production Kubernetes operations.',
    'a1000000-0000-0000-0000-000000000001'
  );
...
values
  ...
  (
    'd2000000-0000-0000-0000-00000000000f',
    'd1000000-0000-0000-0000-000000000006',
    'a5000000-0000-0000-0000-00000000000a',
    'completed',
    current_timestamp - interval '20 days',
...
set
  rating = 5,
  review_text = 'Clear, well-paced, and the hands-on labs actually worked first try.'
where
  id = 'd1000000-0000-0000-0000-000000000001';
...
set
  rating = 4,
  review_text = 'Good refresher, wish the reporting section had a real example walkthrough.'
where
  id = 'd1000000-0000-0000-0000-000000000002';
...
values
  (
    ...
    'a5000000-0000-0000-0000-000000000004',
    'e91cb03e-fb7a-424d-84ff-18e2791ce0b5',
    'Is the free tier enough to complete the hands-on exercises in this module?',
    current_timestamp - interval '14 days'
  );
